Gem::Specification.new do |s|
  ...
  s.files       = ["lib/yolo.rb", "lib/yolo/tasks.rb", "lib/yolo/tests.rb", "lib/yolo/tasks/ios/build.rb", "lib/yolo/tasks/ios/release.rb", "lib/yolo/tasks/ios/test.rb", "lib/yolo/tests/ios/calabash.rb"]
